...
export const defaultInstagramPosts: InstagramPost[] = [
  ...
  },
  {
    ...
    caption: 'Dreck an den Schuhen. Rauch in den Klamotten. Geschichten im Kopf. Zehn Tage ohne Handy und Steckdose – dafür mit den besten Leuten am Lagerfeuer.',
    date: '18. Jul 2024',
    likes: 247,
    comments: 32,
  ...
  },
  {
    ...
    caption: 'Jugend leitet Jugend! Planungswochenende und Regiokonferenz – das Leitungsteam bereitet die nächste Saison vor. Volle Motivation für 2026!',
    date: '28. Sep 2024',
    likes: 156,
    comments: 14,
  ...
  },
  {
    ...
    caption: 'Actionwochenende: Zwei Teams, ein Wald, Fahnenklau und volles Tempo bis zur letzten Sekunde. Zusammenhalt wird hier nicht erklärt, sondern gelebt!',
    date: '22. Nov 2024',
    likes: 198,
    comments: 23,
